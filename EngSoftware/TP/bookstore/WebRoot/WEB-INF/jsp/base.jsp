...
<html>
	...
	<body onload="autoFieldFocus()" bgcolor="C3B698">
		...
		<div align="center">
			<div id="corpo">
				<div class="cabecalho" id="cabecalho" style="display:table;">
					<img src="${ctx}/imagens/lotsofbooks.png" />
					<div class="containerUsuario">					
						<ul id="navigationUsuario1">
							<li><a href="#" style="color:#654010">
									Olá, visitante!
								</a>
				...
				<div id="tabs6"  style="width:50px;text-align:center;background: url(${ctx}/imagens/btn1.png)">
					<ul id="navigationUsuario1">
						...
						<li style="color:#654010;height:21px">Buscas
							<ul class="navigationUsuario2">
								<li>
									<n:link url="/busca/livro" onmouseover="Tip(\"Nova busca\")">Livros</n:link>
								</li>
							</ul>
						</li>
				...
				<div id="tabs6" style="width:80px;text-align:center;background: url(${ctx}/imagens/btn2.png)">
					<ul id="navigationUsuario1" >
						...
						<li style="color:#654010;height:21px"> Cadastros
							<ul class="navigationUsuario2">
								<li>
									<n:link url="/busca/livro?ACAO=criar" onmouseover="Tip(\"Cadastro de livro\")">Livro</n:link>
								</li>
								<li>
									<n:link url="/cadastro/pessoa?ACAO=criar" onmouseover="Tip(\"Cadastro de participante\")">Participante</n:link>
								</li>
								<li>
									<n:link url="/logout.jsp" onmouseover="Tip(\"Cadastro de tipo de participação\")">Tipo de participação</n:link>
								</li>
								<li>
									<n:link url="/logout.jsp" onmouseover="Tip(\"Cadastro de livro\")">Livro</n:link>
								</li>
								<li>
									<n:link url="/logout.jsp" onmouseover="Tip(\"Cadastro de venda\")">Venda</n:link>
								</li>
								<li>
									<n:link url="/logout.jsp" onmouseover="Tip(\"Cadastro de notícia\")">Notícia</n:link>
								</li>
								<li>
									<n:link url="/logout.jsp" onmouseover="Tip(\"Cadastro de crítica\")">Crítica</n:link>
								</li>
							</ul>
						</li>
				...
				<div id="tabs6" style="width:90px;text-align:center;background: url(${ctx}/imagens/btn3.png)">
					<ul id="navigationUsuario1">
						...
						<li style="color:#654010;height:21px">Estatísticas
							<ul class="navigationUsuario2" >
								<li>
									<n:link url="#" onmouseover="Tip(\"Estatísticas de livros\")" style="text-align:left">Livros:</n:link>
								</li>
								<li>
									<n:link url="/busca/livro?ACAO=topvendas" onmouseover="Tip(\"Estatísticas de livros\")">+Vendidos</n:link>
								</li>
								<li>
									<n:link url="/busca/livro?ACAO=topvriticas" onmouseover="Tip(\"Estatísticas de livros\")">+Criticados</n:link>
								</li>
								<li>
									<n:link url="/busca/livro?acao=topnoticias" onmouseover="Tip(\"Estatísticas de livros\")">+Noticiados</n:link>
								</li>
								
								<li>
									<n:link url="#" onmouseover="Tip(\"Estatísticas de autores\")" description="teste" style="text-align:left">Autores:</n:link>
								</li>
								<li>
									<n:link url="#" onmouseover="Tip(\"Estatísticas de autores\")">+Vendidos</n:link>
								</li>
								<li>
									<n:link url="#" onmouseover="Tip(\"Estatísticas de autores\")">+Criticados</n:link>
								</li>
								<li>
									<n:link url="#" onmouseover="Tip(\"Estatísticas de autores\")">+Noticiados</n:link>
								</li>
								
								<li>
									<n:link url="#" onmouseover="Tip(\"Estatísticas de gêneros\")" style="text-align:left">Gêneros:</n:link>
								</li>
								<li>
									<n:link url="#" onmouseover="Tip(\"Estatísticas de gêneros\")">+Vendidos</n:link>
								</li>
								<li>
									<n:link url="#" onmouseover="Tip(\"Estatísticas de gêneros\")">+Criticados</n:link>
								</li>
								<li>
									<n:link url="#" onmouseover="Tip(\"Estatísticas de gêneros\")">+Noticiados</n:link>
								</li>
							</ul>
						</li>
				...
				<div id="tabs6" style="width:1128px;height:23px;text-align:center;background: url(${ctx}/imagens/btnresto.png)">
					<ul id="navigationUsuario1" >
					</ul>
				</div>
<!--				<div class="containerUsuario">					-->
...
<!--				</div>-->
			...
			<div class="conteudo">
					...
					<div class="flash_notice" id="Flash-message" style="font-size: 12px;"></div>
