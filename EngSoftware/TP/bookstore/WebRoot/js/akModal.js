...
jQuery.extend({
	...
	showAkModal:function(navurl,title,box_width,box_height)
	{
	    ...
	    if(box_height > window.innerHeight) box_height = window.innerHeight;

	    $('body').append("<div id='ak_modal_div' style='padding-top:0px;border:1px solid black;background-color:#FFF;position: absolute;z-index:1000;display:none;' ><iframe width='"+box_width+"' height='"+box_height+"'  frameborder=0 marginwidth='0' marginheight='0' scrolling='YES'  name='frmTest' src='"+navurl+"'></iframe></div>");
	...
	showAkModalFull:function(navurl,title)
	{
	    var offset={};
	    var options ={
	    margin:1,
	    ...
	    $('body').append("<div id='ak_modal_div' style='padding-top:0px;border:1px solid black;background-color:#FFF;position: absolute;z-index:1000;display:none;' ><iframe width='"+win_width+ "px' height='"+win_height+"'  frameborder=0 marginwidth='0' marginheight='0' scrolling='YES'  name='frmTest' src='"+navurl+"'></iframe></div>");
	    $('#ak_modal_div').css({left:'1px',top:'1px'});
...
//	    $('#ak_modal_div').css({left:(((win_width/2-box_width/2))+scrollToLeft)+'px',top:(((win_height/2-box_height/2))+scrollToBottom)+'px'});
	...
	akModalRemoveOnly:function(remove)
	{
	   $('#ak_modal_div').fadeOut(500);
	   $('#ak_modal_div').remove();
	},
	
	akModalRemove:function(remove)
	{
	   $('#ak_modal_div').fadeOut(500);
	   $('#ak_modal_div').remove();
	   $.dimScreenStop();
