...
ColVis.prototype = {
	...
	"_fnConstruct": function ()
	{
		...
		////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		////// w3 - inserido o Id para posicionamento do botão 'EXIBIR / OCULTAR COLUNAS' ao lado do botão 'REINICIAR'
		////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////		
		this.dom.wrapper.id = "ColVisTableTools";
				
		this.dom.button = this._fnDomBaseButton( this.s.buttonText );
		this.dom.button.id = "btn_exibirocultarcolunas";
	...
	"_fnDomRestoreButton": function ()
	{
		...
		///////////////////////////////////////////////////////////////
		/////// w3 - alinhamento do texto a esquerda ao clicar em EXIBIR / OCULTAR COLUNAS
		///////////////////////////////////////////////////////////////
		$(nButton).css('text-align','left');
	...
	"_fnDomColumnButton": function ( i )
	{
		...
		$(nButton).click( function (e) {
			...
			///////////////////////////////////////////////////////////////			
			salvaOrdemusuario(that.s.dt.aoColumns, 'click');
