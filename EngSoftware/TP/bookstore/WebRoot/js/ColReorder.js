...
{
	//console.log( "a", oSettings)
	//console.log("b", iFrom)
	//console.log("c", iTo )
	
	//NÃO DEIXA MOVER COLUNAS TRAVADAS (Obs: Para funcionar no Internet Explorer é preciso utilizar inArray da jQuery)
	//if( oSettings.oInit.iFixedCol.indexOf(iFrom)!= -1 || oSettings.oInit.iFixedCol.indexOf(iTo) != -1 )
	if( $.inArray(iFrom, oSettings.oInit.iFixedCol) != -1 || $.inArray(iTo, oSettings.oInit.iFixedCol) != -1 )
		return ;
	...
	///////////////////////////////////////////////////////////////
	/////// w3 - método para salvar opção do usuário
	///////////////////////////////////////////////////////////////
	if(salvaOrdem)
		salvaOrdemusuario(oSettings.aoColumns, 'move');
	salvaOrdem = false;
...
/////////////////////////////////////////////////////////////////////////////////////////
////////    W3 - ALTERAÇÃO FEITA PARA FIXAR DETERMINADAS COLUNAS INDEPENDENTE DA POSIÇÃO
/////////////////////////////////////////////////////////////////////////////////////////
		/**
		 * Array de colunas travadas
		 *  @property fixedCol
		 *  @type     array
		 *  @default  []
		 */
...
ColReorder.prototype = {
	...
	"_fnConstruct": function ()
	{
		...
		/* Colunas fixas  */
		if ( typeof this.s.init.iFixedCol != 'undefined' )
		{
			this.s.fixedCol = this.s.init.iFixedCol;
		}
		...
		{
			////////////////////////////
			/////// w3 - Ao invés de utilizar o fidex, utilizar fixedCol para que funcione corretamente a trava das colunas
			////////////////////////////
			//if ( i > this.s.fixed-1)
			//if (this.s.fixedCol.indexOf(i) == -1)
			if ($.inArray(i, this.s.fixedCol) == -1)
			{
