...
public class Parser {
	private Lexer lex;    // analisador l ́xico para este analisador sint ́tico

	private Token look;   // lookahead token
	Env top = null;       // tabela de s ́mbolos corrente ou do topo

	int used = 0;         // mem ́ria usada para declara ̧~es
	...
	Access offset(Id a) throws IOException {    // I -> [E] | [E] I
		...
		Type type = a.type;
		match('['); i = bool(); match(']');      // primeiro  ́ndice, I -> [ E ]
